  ...
  <div class="card" id="sectA">
    <div class="card-body register-card-body">
      ...
      <div style="text-align: center;">
        <!--
        <a href="#" onclick="contributorregistration();" class="text-center">Not an admin? Click here to register</a>
      -->
      </div>
    </div>
    <!-- /.form-box -->
  ...
  <div class="card" id="sectB">
    <div class="card-body register-card-body">
      ...
      <form id="frmregister" name="frmregister">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Phone No" id="phoneno" name="phoneno">
          <div class="input-group-append">
            <div class="input-group-text">
      ...
      <a href="#" onclick="switcher();" class="text-center">I already have an account</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
...
<script>
  ...
  /* Validate quantity */
  $("#phoneno").on("keypress keyup paste", function(e) {
  ...
  $(document).ready(function(){
    ...
    $("#btnregister").click(function(){
      ...
      if (fullname==''||username==''||password1==''||password2==''||email==''||phoneno==''){
        $("#dmodaltext").text('One or more fields are empty');
        $('#dmodalbtn').trigger("click");        
      }else{
        if (password1!=password2){
          $("#dmodaltext").text('Password Validation Error');
          $('#dmodalbtn').trigger("click");     
        }else{
           if (validateEmail(email)) {
              var formdata = $("#frmregister").serialize();
              $.post("<?php echo site_url('/contribution/registration'); ?>",formdata).done(function(data) {        
                  if(data==1){
                    resetentry();
                    ...
                    $("#dmodaltext").text('Username Address Already Exist! Duplicate Username Not Allowed');
                    $('#dmodalbtn').trigger("click");                              
                  }else{
                    alert(data);
                  }
