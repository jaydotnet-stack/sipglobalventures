                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="card-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="updatecontribution();">Approve</button>
                      </div>
...
<script>
  ...
  function fetchallapplicants(){
    ...
    $.getJSON("<?php echo site_url('/contribution/fetchallapplicants'); ?>",function(data){
      if (data!=0){
  ...
  function updatecontribution(){
    ...
    var checkboxes = document.getElementsByName("applcnt[]"); 
    for (i = 0; i < checkboxes.length; i++) {
      //var chkval = (checkboxes[i].value).trim();
      //alert(chkval);
    ...
    if (chkcnt==0){
      $("#dmodaltext").text('None of the Applicant(s) is selected. Please select the applicant(s) to be approved');
      $('#dmodalbtn').trigger("click");
    }else{
      var formdata = $("form").serialize();
      if(confirm("Approve Selected Applicant(s) Now?")==true){
        $.post("<?php echo site_url('/contribution/approveapplicants'); ?>",formdata).done(function(data) {  
          if(data==1){
            fetchallapplicants();
            $("#smodaltext").text('Approval Successfully');
